...
namespace BankingWebAPI.Infrastructure.Migrations.BankingDb
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankVerificationNumber = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    LocalGovernmentOrigin = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeneficiaryBank = table.Column<int>(type: "int", nullable: false),
                    AccountOfficer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyTypes = table.Column<int>(type: "int", nullable: false),
                    ...
                    BeneficiaryBank = table.Column<int>(type: "int", maxLength: 50, nullable: true),
